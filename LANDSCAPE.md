...
|---|---|---|---|---|---|:---:|---|
| **`scripts/alt_from_ollama.py`** (used) | local CPU/GPU | Gemma 3 4B (gemma3:4b) via Ollama | `--lang` + project doc | $0 | BSD-3-Clause | ✓ | Offline, predictable. |
