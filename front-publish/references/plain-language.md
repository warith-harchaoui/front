...
python scripts/plain_language.py --preserve "Front,Tailwind,Montserrat" --input copy.md
...
- [ ] No buzzwords in the output (`python front-ui/scripts/validate.py` will catch them if the file is committed).
