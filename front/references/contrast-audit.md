...
python front/scripts/audit_contrast.py

# AAA threshold
python front/scripts/audit_contrast.py --target 7

# Large-text / UI threshold
python front/scripts/audit_contrast.py --target 3

# Audit an external palette and suggest fixes
python front/scripts/audit_contrast.py --palette my-palette.json --fix

# JSON output for CI
python front/scripts/audit_contrast.py --format json
```
...
- name: Contrast audit
  run: |
    python3 front/scripts/audit_contrast.py \
