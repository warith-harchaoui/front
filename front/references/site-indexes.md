...
python front/scripts/site_indexes.py --root . --base-url https://example.com

# Project with a blog folder under posts/
python front/scripts/site_indexes.py --root . --base-url https://example.com --feed-from posts

# Force RSS 2.0 for clients that haven't moved past 2002
python front/scripts/site_indexes.py --root . --base-url https://example.com --feed-from posts --rss

# Ship a humans.txt explicitly
python front/scripts/site_indexes.py --root . --base-url https://example.com --humans

# Override the output directory (default: --root)
python front/scripts/site_indexes.py --root . --base-url https://example.com --out public
```
