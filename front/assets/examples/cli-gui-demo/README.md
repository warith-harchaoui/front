...
```bash
cd front/assets/examples/cli-gui-demo
python server.py
```
...
- **WCAG audit** — `python front/scripts/lint_a11y.py front/assets/examples/cli-gui-demo/public/` should pass; this demo is meant to be a clean baseline.
